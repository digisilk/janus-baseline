...
layout = dbc.Container([
            ...
            html.Div([
                *(
                    [
                        html.Button(
                            'Download URLs CSV',
                            id='historical-btn-csv-urls',
                            className='btn btn-outline-secondary btn-sm mt-1 me-2',
                            disabled=True,
                        ),
                        html.Button(
                            'Download Subdomains CSV',
                            id='historical-btn-csv-subdomains',
                            className='btn btn-outline-secondary btn-sm mt-1 me-2',
                            disabled=True,
                        ),
                        html.Button(
                            'Download Domains CSV',
                            id='historical-btn-csv-domains',
                            className='btn btn-outline-secondary btn-sm mt-1',
                            disabled=True,
                        ),
                    ] if ENABLE_CSV_EXPORT else [
                        html.Div(id='historical-btn-csv-urls'),
                        html.Div(id='historical-btn-csv-subdomains'),
                        html.Div(id='historical-btn-csv-domains'),
                    ]
                ),
            ], className='mb-2'),
            html.Div([
    ...
    dcc.Store(id='historical-csv-store-urls'),
    dcc.Store(id='historical-csv-store-subdomains'),
    dcc.Store(id='historical-csv-store-domains'),
    # dcc.Download components — invisible; activated by download callbacks
    dcc.Download(id='historical-download-csv-urls'),
    dcc.Download(id='historical-download-csv-subdomains'),
    dcc.Download(id='historical-download-csv-domains'),
